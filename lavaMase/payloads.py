...
class TrackStartEventPayload:
    ...
    original: :class:`~wavelink.Playable` | None
        The original track associated this event. E.g. the track that was passed to :meth:`~wavelink.Player.play.py` or
...
class TrackExceptionEventPayload:
    ...
    def __init__(self, player: Player | None, track: Playable, exception: TrackExceptionPayload) -> None:
        self.player = cast(lavaMase.Player, player)
        self.track = track
...
class WebsocketClosedEventPayload:
    """Payload received in the :func:`on_lava_websocket_closed` event.
...
class PlayerUpdateEventPayload:
    """Payload received in the :func:`on_lava_player_update` event.
